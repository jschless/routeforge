...
| 28 | `lab28_dhcp_snooping_and_dai` | `src/routeforge/runtime/phase2.py` | `dhcp_snooping_dai` |
| 29 | `lab29_port_security_and_ip_source_guard` | `src/routeforge/runtime/phase2.py` | `port_security_ip_source_guard` |
| 30 | `lab30_qos_policing_and_shaping` | `src/routeforge/runtime/phase2.py` | `qos_police_shape` |
| 31 | `lab31_qos_congestion_avoidance_wred` | `src/routeforge/runtime/phase2.py` | `qos_wred_decision` |
| 32 | `lab32_route_redistribution_and_loop_prevention` | `src/routeforge/runtime/phase2.py` | `redistribute_with_loop_guard` |
| 33 | `lab33_fhrp_tracking_and_failover` | `src/routeforge/runtime/phase2.py` | `fhrp_track_failover` |
| 34 | `lab34_ipv6_nd_slaac_and_ra_guard` | `src/routeforge/runtime/phase2.py` | `ipv6_nd_slaac_ra_guard` |
| 35 | `lab35_ospfv3_adjacency_and_lsdb` | `src/routeforge/runtime/phase2.py` | `ospfv3_adjacency_lsdb` |
| 36 | `lab36_mpbgp_ipv6_unicast` | `src/routeforge/runtime/phase2.py` | `mpbgp_ipv6_unicast` |
| 37 | `lab37_mpls_ldp_label_forwarding` | `src/routeforge/runtime/phase2.py` | `mpls_ldp_lfib` |
| 38 | `lab38_l3vpn_vrf_and_route_targets` | `src/routeforge/runtime/phase2.py` | `l3vpn_vrf_route_targets` |
| 39 | `lab39_bgp_evpn_vxlan_basics` | `src/routeforge/runtime/phase2.py` | `evpn_vxlan_control` |
