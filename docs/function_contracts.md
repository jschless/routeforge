...
| 6 | `lab06_arp_and_adjacency` | `ArpAdjacencyTable.queue_packet(self, *, next_hop_ip: 'str', packet_id: 'str') -> 'bool' -> bool<br>ArpAdjacencyTable.resolve(self, *, next_hop_ip: 'str', mac: 'str') -> 'list[str]' -> list[str]` | `ARP_REQUEST_TX, ARP_REPLY_RX, ARP_CACHE_UPDATE` |
...
| 12 | `lab12_ospf_network_types_and_dr_bdr` | `_election_order(candidates: 'list[DrCandidate]') -> 'list[DrCandidate]' -> list[DrCandidate]<br>failover_dr_bdr(candidates: 'list[DrCandidate]', *, active_router_ids: 'set[str]') -> 'tuple[str, str \| None]' -> tuple[str, str \| None]` | `OSPF_DR_ELECT, OSPF_BDR_ELECT, OSPF_DR_FAILOVER` |
...
| 16 | `lab16_udp_tcp_fundamentals` | `classify_flow(*, src_ip: 'str', dst_ip: 'str', src_port: 'int', dst_port: 'int', protocol: 'str') -> 'FlowKey' -> FlowKey<br>validate_udp(*, length_bytes: 'int', checksum_valid: 'bool') -> 'bool' -> bool` | `FLOW_CLASSIFY, TCP_STATE_CHANGE, UDP_VALIDATE` |
...
| 26 | `lab26_observability_and_ops` | `readiness_check(*, checks: 'dict[str, bool]') -> 'ReadinessResult' -> ReadinessResult<br>emit_telemetry(*, component: 'str', counters: 'dict[str, int]', timestamp_s: 'int') -> 'dict[str, object]' -> dict[str, object]` | `OPS_READINESS_CHECK, TELEMETRY_EMIT` |
