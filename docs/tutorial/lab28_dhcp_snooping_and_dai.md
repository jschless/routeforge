...
- Implement `dhcp_snooping_dai` in `src/routeforge/runtime/phase2.py`.
...
Layer-2 access security with binding-based ARP validation. Student-mode coding target for this stage is `src/routeforge/runtime/phase2.py` (`dhcp_snooping_dai`).
...
3. Edit only `dhcp_snooping_dai` in `src/routeforge/runtime/phase2.py`.
...
- Intentionally break `dhcp_snooping_dai` in `src/routeforge/runtime/phase2.py` and rerun `routeforge check lab28` to confirm tests catch regressions.
