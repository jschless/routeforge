...
- Implement `ospfv3_adjacency_lsdb` in `src/routeforge/runtime/phase2.py`.
...
OSPFv3 neighbor formation and IPv6 LSDB state transitions. Student-mode coding target for this stage is `src/routeforge/runtime/phase2.py` (`ospfv3_adjacency_lsdb`).
...
3. Edit only `ospfv3_adjacency_lsdb` in `src/routeforge/runtime/phase2.py`.
...
- Intentionally break `ospfv3_adjacency_lsdb` in `src/routeforge/runtime/phase2.py` and rerun `routeforge check lab35` to confirm tests catch regressions.
