...
ARP resolution, cache updates, and pending queue behavior. Student-mode coding target for this stage is `src/routeforge/runtime/adjacency.py` (`ArpAdjacencyTable.resolve`).
