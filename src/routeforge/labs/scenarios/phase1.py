...
from routeforge.labs.scenarios.capstone import forward_outcome, icmp_outcome
...
def _lab08() -> LabRunResult:
    ...
    ok_outcome = forward_outcome(forward_packet_input, decision_ok, ("TTL_DECREMENT", "FIB_FORWARD"))
    ...
    drop_outcome = forward_outcome(drop_packet_input, decision_drop, ("FIB_DROP",))
...
def _lab09() -> LabRunResult:
    ...
    echo_outcome = icmp_outcome(echo_packet, echo_decision, "ICMP_ECHO_REPLY")
    ...
    unreachable_outcome = icmp_outcome(unreachable_packet, unreachable_decision, "ICMP_UNREACHABLE")
    ...
    ttl_outcome = icmp_outcome(ttl_packet, ttl_decision, "ICMP_TIME_EXCEEDED")
